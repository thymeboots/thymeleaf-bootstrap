...
public class TagBsLabel extends com.github.thymeboots.thymeleaf.bootstrap.comp.UIOutput {
	...
	private static final String TAG_HTML       = "label";
	private static final String TAG_BOOTSCLASS = "control-label";
	private static final int    PRECEDENCE = 1000;
		
    public TagBsLabel(final String dialectPrefix, String    tagVersion) {
