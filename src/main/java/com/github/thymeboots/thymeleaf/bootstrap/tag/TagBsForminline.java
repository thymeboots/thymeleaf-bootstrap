 ...
 *
 */
public class TagBsForminline extends com.github.thymeboots.thymeleaf.bootstrap.comp.UIOutput {
	private static final String TAG_NAME       = "forminline";
	private static final String TAG_HTML       = "div";
	private static final String TAG_BOOTSCLASS = "form-inline";
	private static final int    PRECEDENCE = 1000;
	
	
    public TagBsForminline(final String dialectPrefix, String    tagVersion) {
